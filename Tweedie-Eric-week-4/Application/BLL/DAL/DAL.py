...
class Student:
    ...
    def addStudenttoDB(self, student_data):
        ...
        sql = ("INSERT INTO Student" 
               "(id, first_name, last_name, email_address, date_of_birth, student_grade, class_grade, class_id, teacher_id, teacher_first_name, teacher_last_name, teacher_email, dept)"
...
def call_addStudent(params):
    ...
    sql = "SELECT addStudent (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
    val = params
    cursor.execute(sql, val)
    cnx.commit()
