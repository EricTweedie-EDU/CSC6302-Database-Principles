...
CREATE TABLE IF NOT EXISTS Student(id INT AUTO_INCREMENT PRIMARY KEY, first_name varchar(50), last_name varchar(50), email_address varchar(100), 
                                date_of_birth Date, student_grade INT, class_grade varchar(1), class_id INT, teacher_id INT, teacher_first_name varchar(50), teacher_last_name varchar(50), 
									teacher_email varchar(100),dept varchar(50));
