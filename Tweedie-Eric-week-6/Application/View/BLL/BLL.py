...
def addStudentfunc(info, username, password):
    ...
    # call the DAL function to add the student
    DAL.call_addStudent(new_student, username, password)

def teacher_id(firstname, lastname, username, password):

    return DAL.get_teacher_id(firstname, lastname, username, password)

def search_all_students(username, password):

    return DAL.call_getAllStudents(username, password)
